...
El cuadro donde dice "Buffer", son las variables globales que interactuan con las funciones del programa. Estas variables globales son: 
\begin{itemize}
