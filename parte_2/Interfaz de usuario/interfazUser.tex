...
\subsection{Pass}
Pass no es una aplicación para PC en sí. Es una página web con todos los satélites representados en un mapa. La página es http://amsat.org.ar/pass. La captura de pantalla se muestra en la siguiente figura:% \ref{fig:iu_pass}.
\begin{figure}[ht]
	\centering
...
Para crear un módulo, debe dirigirse a file $\rightarrow$ new module, como se muestra en la siguiente imagen:% \ref{fig:create_modul_gpred}  
\begin{figure}[ht]
	\centering
...
Luego, debe presionar donde muestra la imagen anterior para empezar a agregar el primer dispositivo. Se realiza un clic sobre el símbolo recuadrado en rojo de la figura anterior, se abre la siguiente ventana, donde deben elegirse los parámetros para configurar el dispositivo hacia cual enviará los datos.
