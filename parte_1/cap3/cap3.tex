...
Aquí, definimos algunos de los componentes de hardware seleccionados para cumplir con los requerimientos, en particular, definimos el microcontrolador, la interfaz de red, y la interfaz de usuario del sistema. En esta sección, el análisis se basa sobre componentes disponibles en el IAR, de estos componentes, seleccionamos aquellos, que cumplen el requisito de bajo costo, y luego sobre los mismos, analizamos su facilidad de programación, librerias disponibles, módulos disponibles sobre estos, y otros aspectos.  
\end{tcolorbox}
\end{center}    
...
\end{enumerate}
 ...
 De los placas de desarrollo que hay actualmente en el IAR, se tienen las siguiente placas a analizar: 
